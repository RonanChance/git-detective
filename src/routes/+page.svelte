...
<div class="text-[var(--black)]">
    ...
    <div class="flex flex-row w-full justify-center items-center mt-12 mb-14 gap-4">
        <a href="https://github.com/RonanChance/git-detective" target="_blank" data-value="github" style="border-radius:4px;" class="py-2 px-2 flex justify-center items-center bg-black hover:bg-gray-900 text-white transition ease-in duration-100 text-center text-base font-semibold shadow-md focus:outline-none">
